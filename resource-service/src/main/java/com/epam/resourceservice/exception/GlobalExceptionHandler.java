...
public class GlobalExceptionHandler {
    ...
    public ErrorDto handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex) {
        ...
        log.warn("Argument Type Mismatch: {}. handleMethodArgumentTypeMismatch: value={}", ex.getMessage(), ex.getValue());
    ...
    public ErrorDto handleResourceNotFoundException(ResourceNotFoundException ex) {
        log.warn("Resource Not Found: {}. handleResourceNotFoundException: message={}", ex.getMessage(), ex.getMessage());
    ...
    public ErrorDto handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException ex) {
        ...
        log.warn("Media Type Not Supported: {}. handleHttpMediaTypeNotSupportedException: message={}", ex.getMessage(), errorMessage);
        return new ErrorDto(errorMessage, "400");
    }
